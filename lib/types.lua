...
---@class Hs.Vimnav.Cache
---@field elements table Cached elements
---@field attributes table Cached element attributes
---@field electron table Cached element electron
